  ...
  class Persian_Glyphs
{
    ...
    public function __construct()
    {
        $this->_glyphs = [
            ...
            'ی'  => ['&#x06CC', '&#xFEF3', '&#xFEF4', '&#xFEF0'],
            'م'  => ['&#x0645', '&#xFEE3', '&#xFEE4', '&#xFEE2'],
            'پ'  => ['&#xFB56', '&#xFB58', '&#xFB59', '&#xFB57'],
            'ژ'  => ['&#x0698', null, null, '&#xFB8B'],
            '0'  => ['&#x06F0', null, null, null],
            '1'  => ['&#x06F1', null, null, null],
            '2'  => ['&#x06F2', null, null, null],
            '3'  => ['&#x06F3', null, null, null],
            '4'  => ['&#x06F4', null, null, null],
            '5'  => ['&#x06F5', null, null, null],
            '6'  => ['&#x06F6', null, null, null],
            '7'  => ['&#x06F7', null, null, null],
            '8'  => ['&#x06F8', null, null, null],
            '9'  => ['&#x06F9', null, null, null],
            '؟'  =>  ['&#x061F', null, null, null], // علامت سوال
            '?'  => ['&#x003F', null, null, null], // علامت سوال
            '!'  => ['&#x0021', null, null, null], // 
        ];
    }
    ...
    public function utf8Glyphs($str)
    {
        ...
        foreach ($textPara as $text) {
            // بررسی اعداد و جلوگیری از معکوس شدن آن‌ها
            if (preg_match('/\d/', $text)) {
                $output[] = $text; // اعداد را بدون تغییر وارد خروجی می‌کنیم
                continue;
            }

            // بررسی حروف انگلیسی و اضافه کردن آن‌ها بدون تغییر
            if (preg_match('/[a-zA-Z]/', $text)) {
                $output[] = $text; // حروف انگلیسی را بدون تغییر وارد می‌کنیم
                continue;
            }
